...
class SAC(object):
    ...
    def save_model(self, actor_path='models/actor.pth', critic_path='models/critic.pth'):
    ...
    def load_model(self, actor_path='models/actor.pth', critic_path='models/critic.pth'):
